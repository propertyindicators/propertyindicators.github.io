...
var AddrForm = /** @class */ (function () {
    function AddrForm(search, renderer, el) {
        ...
        this.onAddrChanged = new core_1.EventEmitter();
    ...
    AddrForm.prototype.onDistrIn = function (distr) {
        ...
        this.onAddrChanged.emit(this.addr); //передача сообщения о смене аддреса родительской компоненте
    };
    ...
    ], AddrForm.prototype, "onAddrChanged", void 0);
    __decorate([
