...
var RemStateModel = /** @class */ (function () {
    function RemStateModel() {
        ...
        this.devaluation_dict = {
            0: ["Укажите состояние внутренней отделки", 0],
            1: ["Незаконченный ремонт", 0],
            2: ["Сильно изношенное состояние (требуется ремонт)", 0.25],
        ...
        // Additional interior decoration/functionality elements dictionary
        this.tfa_dict = {
            networks: ["Современная электрическая и компьютерная разводка", false, 0.5],
            conditioning: ["Системы кондиционирования воздуха", false, 1],
            fireAlarm: ["Пожарная сигнализация", false, 0.5],
            securityAlarm: ["Охранная сигнализация", false, 0.5],
            firefighting: ["Система пожаротушения", false, 1],
            furniture: ["Полностю меблировано в соответсвие с классом отделки", false, 2],
