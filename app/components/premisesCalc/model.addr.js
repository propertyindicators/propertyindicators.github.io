...
var AddrModel = /** @class */ (function () {
    ...
    // Additional fields for commercial property
    peopleStreamValue, transportStreamValue, destinationCenter) {
        ...
        if (peopleStreamValue === void 0) { peopleStreamValue = 0; }
        if (transportStreamValue === void 0) { transportStreamValue = 0; }
        if (destinationCenter === void 0) { destinationCenter = 0; }
        ...
        this.peopleStreamValue = peopleStreamValue;
        this.transportStreamValue = transportStreamValue;
        ...
        this.massivedict = {
            ...
            63: "Шулявка (Северная)",
            64: "Шулявка (Южная)",
            65: "Совки(частный сектор)",
            66: "Выдубичи(промзона)",
            67: "Троещина(частный сектор)",
            68: "Быковня(частный сектор)",
            69: "Бортничи(частный сектор)",
            70: "Жуляны",
            71: "Пуща-Водица",
            72: "Куреневка_Оболонь(промзона)",
            73: "Дарница(промзона)",
            74: "Борщаговка(Софиевская)",
            75: "Борщаговка(Петропавловская)",
            76: "Пирогово",
            77: "Чапаевка",
            78: "Гидропарк",
        };
    ...
    AddrModel.prototype.setNullData = function () {
        ...
        this.peopleStreamValue = 0;
        this.transportStreamValue = 0;
        this.destinationCenter = 0;
    };
    return AddrModel;
}());
